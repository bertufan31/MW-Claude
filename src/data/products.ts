...
export const products: Product[] = [
  {
    ...
    price: 79.99,
    originalPrice: 99.99,
    image: '/products/starter-pack/1.jpg',
    images: ['/products/starter-pack/1.jpg', '/products/starter-pack/2.jpg', '/products/starter-pack/3.jpg'],
    category: 'bundles',
    featured: true,
    bestseller: true,
    inStock: true,
  ...
  },
  {
    ...
    price: 24.99,
    image: '/products/clear-quartz/1.jpg',
    images: ['/products/clear-quartz/1.jpg', '/products/clear-quartz/2.jpg'],
    category: 'crystals',
    bestseller: true,
    inStock: true,
    stockCount: 100,
  ...
  },
  {
    ...
    price: 22.99,
    image: '/products/rose-quartz/1.jpg',
    images: ['/products/rose-quartz/1.jpg', '/products/rose-quartz/2.jpg'],
    category: 'crystals',
    new: true,
    inStock: true,
    stockCount: 75,
  ...
  },
  {
    ...
    price: 28.99,
    image: '/products/amethyst/1.jpg',
    images: ['/products/amethyst/1.jpg', '/products/amethyst/2.jpg'],
    category: 'crystals',
    inStock: true,
    stockCount: 60,
    details: [
  ...
  },
  {
    ...
    price: 12.99,
    image: '/products/white-sage-bundle/1.jpg',
    images: ['/products/white-sage-bundle/1.jpg'],
    category: 'sage',
    bestseller: true,
    inStock: true,
    stockCount: 200,
  ...
  },
  {
    ...
    price: 16.99,
    image: '/products/sage-rose-petals/1.jpg',
    images: ['/products/sage-rose-petals/1.jpg'],
    category: 'sage',
    new: true,
    inStock: true,
    stockCount: 80,
  ...
  },
  {
    ...
    price: 14.99,
    image: '/products/palo-santo-sticks/1.jpg',
    images: ['/products/palo-santo-sticks/1.jpg'],
    category: 'palo-santo',
    bestseller: true,
    inStock: true,
    stockCount: 150,
  ...
  },
  {
    ...
    price: 34.99,
    image: '/products/ceramic-moon-vase/1.jpg',
    images: ['/products/ceramic-moon-vase/1.jpg', '/products/ceramic-moon-vase/2.jpg'],
    category: 'vases',
    new: true,
    inStock: true,
    stockCount: 40,
  ...
  },
  {
    ...
    price: 29.99,
    image: '/products/intention-vase/1.jpg',
    images: ['/products/intention-vase/1.jpg'],
    category: 'vases',
    inStock: true,
    stockCount: 55,
    details: [
  ...
  },
  {
    ...
    price: 38.99,
    image: '/products/cat-tarot-cards/1.jpg',
    images: ['/products/cat-tarot-cards/1.jpg', '/products/cat-tarot-cards/2.jpg', '/products/cat-tarot-cards/3.jpg'],
    category: 'cards',
    featured: true,
    bestseller: true,
    inStock: true,
  ...
  },
  {
    ...
    price: 45.99,
    image: '/products/abundance-crystal-set/1.jpg',
    images: ['/products/abundance-crystal-set/1.jpg', '/products/abundance-crystal-set/2.jpg'],
    category: 'crystals',
    new: true,
    inStock: true,
    stockCount: 35,
  ...
  },
  {
    ...
    price: 49.99,
    originalPrice: 59.99,
    image: '/products/cleansing-kit/1.jpg',
    images: ['/products/cleansing-kit/1.jpg', '/products/cleansing-kit/2.jpg'],
    category: 'bundles',
    inStock: true,
    stockCount: 45,
